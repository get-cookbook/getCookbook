...
export default function IngSearch({ addedIngredients, setAddedIngredients }) {
    ...
    return (
        <div className="bg-neutral-800 rounded-br-3xl p-5">
            ...
            {/* <h1 className="text-4xl pl-5">Ingredient List...</h1> */}
            ...
            <div className="ingredients-list flex flex-col bg-white rounded-lg w-full text-black {availableIngredients? 'p-2' : ''}">
